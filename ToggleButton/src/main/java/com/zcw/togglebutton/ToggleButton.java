...
public class ToggleButton extends View{
	...
	public void setup(AttributeSet attrs) {
		...
		offBorderColor = typedArray.getColor(R.styleable.ToggleButton_off_BorderColor, offBorderColor);
		onColor = typedArray.getColor(R.styleable.ToggleButton_on_Color, onColor);
		spotColor = typedArray.getColor(R.styleable.ToggleButton_spot_Color, spotColor);
		offColor = typedArray.getColor(R.styleable.ToggleButton_off_Color, offColor);
