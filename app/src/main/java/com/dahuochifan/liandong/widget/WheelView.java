...
package com.dahuochifan.liandong.widget;
...
import com.dahuochifan.liandong.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xefF4F2F2,
			0xcfF4F2F2, 0xafF4F2F2 };
	/*private int[] SHADOWS_COLORS = new int[] { 0x3fE9E9E9,
			0x00000000, 0x3fE9E9E9 };*/
