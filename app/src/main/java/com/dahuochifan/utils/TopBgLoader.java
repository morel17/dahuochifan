...
public class TopBgLoader {
	private static TopBgLoader loaderBusiness = new TopBgLoader(MyApplication.getInstance());
	private DisplayImageOptions options;
	private AnimateFirstDisplayListener animateFirstListener;

	private TopBgLoader(Context context) {
	...
	public static TopBgLoader getInstance() {
