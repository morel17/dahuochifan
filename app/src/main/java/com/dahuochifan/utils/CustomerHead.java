...
public class CustomerHead {
	private static CustomerHead loaderBusiness = new CustomerHead(
			MyApplication.getInstance());
	private DisplayImageOptions options;
	private AnimateFirstDisplayListener animateFirstListener;

	private CustomerHead(Context context) {

		animateFirstListener = new AnimateFirstDisplayListener();
		options = new DisplayImageOptions.Builder()
				.showImageOnLoading(R.drawable.customerhead)
				.showImageForEmptyUri(R.drawable.customerhead)
				.showImageOnFail(R.drawable.customerhead)
				.cacheInMemory(true)
	...
	public static CustomerHead getInstance() {
