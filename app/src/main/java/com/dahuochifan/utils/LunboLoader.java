...
public class LunboLoader {
	private static LunboLoader loaderBusiness = new LunboLoader(MyApplication.getInstance());
	private DisplayImageOptions options;
	private AnimateFirstDisplayListener animateFirstListener;

	private LunboLoader(Context context) {

		animateFirstListener = new AnimateFirstDisplayListener();
		options = new DisplayImageOptions.Builder()
				.showImageOnLoading(R.drawable.list_bg)
				.showImageForEmptyUri(R.drawable.list_bg)
				.showImageOnFail(R.drawable.list_bg).cacheInMemory(true).cacheOnDisk(true).considerExifParams(true)
	...
	public static LunboLoader getInstance() {
