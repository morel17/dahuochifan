...
public class MainPicLoader {
	private static MainPicLoader loaderBusiness = new MainPicLoader(MyApplication.getInstance());
	private DisplayImageOptions options;
	private AnimateFirstDisplayListener animateFirstListener;

	private MainPicLoader(Context context) {
		animateFirstListener = new AnimateFirstDisplayListener();
		options = new DisplayImageOptions.Builder()
		// .showImageOnLoading(R.drawable.list_bg)
				.showImageForEmptyUri(R.mipmap.splash_pic).showImageOnFail(R.mipmap.splash_pic)
				.cacheInMemory(true)
	...
	public static MainPicLoader getInstance() {
