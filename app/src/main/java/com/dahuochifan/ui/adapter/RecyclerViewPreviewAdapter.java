...
public class RecyclerViewPreviewAdapter extends RecyclerView.Adapter<RecyclerViewPreviewAdapter.ViewHolder> {
    ...
    public RecyclerViewPreviewAdapter(Context context, List<ChefList> list, String locationStr) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int position) {
        ...
        if (getItemViewType(position) == chefType) {
            ...
            viewHolder.chef_like_rl.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            viewHolder.chef_collect_rl.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
...
//        viewHolder.distance_tv.setText(Tools.getDistanc((object.getDistance())));
            ...
            viewHolder.order_rl.setVisibility(View.GONE);
            viewHolder.cardView.setOnClickListener(new NoDoubleClickListener() {
                @Override
                protected void onNoDoubleClick(View v) {
                    if (!MyConstant.user.isLogin()) {
