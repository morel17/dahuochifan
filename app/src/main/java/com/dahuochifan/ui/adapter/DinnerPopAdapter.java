 ...
 * DinnerTimeAdapter
 */
public class DinnerPopAdapter extends RecyclerView.Adapter<DinnerPopAdapter.ViewHolder> {
    private List<CBTime> mData;
    private LayoutInflater inflate;
    private Context context;
    private TopCuisineItemListener listenerZ;

    public DinnerPopAdapter(Context context) {
    ...
    @Override
    public DinnerPopAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHolder holder = new ViewHolder(inflate.inflate(R.layout.adapter_time_pop, parent, false), listenerZ);
        return holder;
    }

    @Override
    public void onBindViewHolder(DinnerPopAdapter.ViewHolder holder, int position) {
