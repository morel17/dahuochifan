...
public class RecyclerViewCurAdapter extends RecyclerView.Adapter<RecyclerViewCurAdapter.ViewHolder> {
...
//    private static final int TYPE_IV = 0x0001;
    ...
    public RecyclerViewCurAdapter(Context context, List<ChefList> list, String locationStr) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private RelativeLayout actiivty_rl;
        ...
        public ViewHolder(View itemView, int itemType) {
            ...
            if (itemType == chefType) {
                ...
                actiivty_rl = (RelativeLayout) itemView.findViewById(R.id.actiivty_rl);
        ...
        if (getItemViewType(position) == chefType) {
            ...
            if (object.getActs() != null) {
                ...
                RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(context.getResources().getDimensionPixelOffset(R.dimen.width_80_80), acts.size()
                        * context.getResources().getDimensionPixelOffset(R.dimen.dh_32));
...
//                    .setPageTransformer(ConvenientBanner.Transformer.DepthPageTransformer);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int type) {
        if (type == chefType) {
            ...
            View itemLayout = inflater.inflate(R.layout.adapter_cheflist_extra, null);
