...
import com.dahuochifan.ui.view.indicator.Indicator.IndicatorAdapter;
import com.dahuochifan.ui.view.indicator.Indicator.OnItemSelectedListener;
import com.dahuochifan.ui.view.indicator.Indicator.OnTransitionListener;
import com.dahuochifan.ui.view.indicator.slidebar.ScrollBar;
import com.dahuochifan.ui.view.viewpager.RecyclingPagerAdapter;
import com.dahuochifan.ui.views.MyViewPager;
import com.dahuochifan.ui.views.MyViewPager.OnPageChangeListener;
...
public class IndicatorViewPager {
	...
	public IndicatorViewPager(Indicator indicator, MyViewPager MyViewPager) {
		super();
	...
	public void setAdapter(IndicatorPagerAdapter adapter) {
		...
		MyViewPager.setAdapter(adapter.getPagerAdapter());
	...
	public void setCurrentItem(int item, boolean anim) {
		MyViewPager.setCurrentItem(item, anim);
	...
	public void setPageOffscreenLimit(int limit) {
		MyViewPager.setOffscreenPageLimit(limit);
	}
	...
	public void setPagePrepareNumber(int limit) {
		MyViewPager.setPrepareNumber(limit);
	}
	...
	public void setPageMargin(int marginPixels) {
		MyViewPager.setPageMargin(marginPixels);
	}
	...
	public void setPageMarginDrawable(Drawable d) {
		MyViewPager.setPageMarginDrawable(d);
	}
	...
	public void setPageMarginDrawable(int resId) {
		MyViewPager.setPageMarginDrawable(resId);
	}
	...
	private OnItemSelectedListener onItemSelectedListener = new OnItemSelectedListener() {
		...
		public void onItemSelected(View selectItemView, int select, int preSelect) {
			MyViewPager.setCurrentItem(select, MyViewPager.isCanScroll());
