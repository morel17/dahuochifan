...
public class MyShikeFragmentThi extends BaseFragment implements OnRefreshListener2<ListView> {
	View view;
	...
	public MyShikeFragmentThi instance;
	// 初始页数
	private int page = 1;
	// 页数size
    ...
    public MyShikeFragmentThi newInstance(){
    	if (instance == null) {
			instance = new MyShikeFragmentThi();
		}
		return instance;
    }
	@Override
