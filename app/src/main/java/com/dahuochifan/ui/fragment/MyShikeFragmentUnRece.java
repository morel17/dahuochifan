...
public class MyShikeFragmentUnRece extends BaseFragment implements OnRefreshListener2<ListView> {
	View view;
	...
	public MyShikeFragmentUnRece instance;
	// 初始页数
	private int page = 1;
	// 页数size
	...
	public MyShikeFragmentUnRece newInstance() {
		if (instance == null) {
			instance = new MyShikeFragmentUnRece();
		}
		return instance;
	}
	@Override
	...
	private void initViews() {
		...
		adapter = new MyShikeAdapterTemp(mActivity);
	...
	public void getShikeOne(boolean isRefresh) {
		...
		params = ParamData.getInstance().getShikeObj(page, pageSize, "3");
