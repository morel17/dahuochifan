...
import com.dahuochifan.ui.adapter.MyShikeAdapterTempYijie;
...
public class MyShikeFragmentYijie extends BaseFragment implements OnRefreshListener2<ListView> {
	View view;
	...
	private MyShikeAdapterTempYijie adapter;
	private ImageView bgiv;
	private ProgressBar pb;
	public MyShikeFragmentYijie instance;
	// 初始页数
	private int page = 1;
	// 页数size
    ...
    public MyShikeFragmentYijie newInstance(){
    	if (instance == null) {
			instance = new MyShikeFragmentYijie();
		}
		return instance;
    }
	@Override
	...
	private void initViews() {
		...
		adapter = new MyShikeAdapterTempYijie(mActivity);
