...
import com.dahuochifan.ui.adapter.MyOrderAdapterTemp3;
...
public class MyOrderFragmentThi extends LazyFragment implements OnRefreshListener2<ListView> {
    private MyOrderFragmentThi instance = null;
    private View view;
    ...
    private MyOrderAdapterTemp3 adapter;
    ...
    static class MyHandler extends Handler {
        ...
        WeakReference<MyOrderFragmentThi> wrReferences;

        MyHandler(PullToRefreshListView puReference, MyOrderFragmentThi wrReferences) {
    ...
    public MyOrderFragmentThi newInstance() {
        if (instance == null) {
            instance = new MyOrderFragmentThi();
        }
        return instance;
    }
    ...
    private void initViews() {
        ...
        adapter = new MyOrderAdapterTemp3(mActivity, 2);
    ...
    private void getDataLoad(RequestParams params2, final boolean isRefresh) {
        ...
        final MyHandler handler = new MyHandler(listView, MyOrderFragmentThi.this);
        client.post(MyConstant.URL_GETORDERLIST, params2, new TextHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                if (BuildConfig.LEO_DEBUG) L.e("responseStringxxx" + responseString);
    ...
    protected void lazyLoad() {
        L.e(isPrepared + "**3*" + isVisible + "***3*" + mHasLoadedOnce);
