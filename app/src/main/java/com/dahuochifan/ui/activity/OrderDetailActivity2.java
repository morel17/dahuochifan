...
public class OrderDetailActivity2 extends BaseActivity implements ActionSheetListener, PlatformActionListener {
    ...
    public static OrderDetailActivity2 instance;
                ...
                case SDK_PAY_FLAG:
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            ...
                            Toast.makeText(context, "订单尚未被支付", Toast.LENGTH_SHORT).show();
                        }
                    }
                    break;
                default:
    ...
    private void getMainData(final boolean isRecyc) {
        params = ParamData.getInstance().getOrderDetail(olids, "0");
        client.post(MyConstant.GET_ORDER_DETAIL, params, new TextHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                MainTools.ShowToast(OrderDetailActivity2.this, R.string.interneterror);
                if (!isRecyc) {
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                ...
                if (info.getResultcode() == 1) {
                    ...
                    if (info != null && info.getTag() != null) {
                        showTipDialog(OrderDetailActivity2.this, info.getTag(), info.getResultcode());
                    } else {
                        showTipDialog(OrderDetailActivity2.this, "未知错误", -1);
                    }
                }
            }
        });
    ...
    public void postSuccess() {
        if (orderinfo != null && !TextUtils.isEmpty(orderinfo.getOlids())) {
            params = ParamData.getInstance().postStatusObj(orderinfo.getOlids(), "10", 0l);
    ...
    private void btn_listner() {
        ...
        top_rl.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrderDetailActivity2.this, ChefDetailActivity.class);
            ...
            public void onClick(View v) {
                if (bottom_tv.getText().equals("给个评价")) {
                    ...
                    if (cancel_rl.isShown() && countView.getRemainTime() < 60000) {
                        new AlertDialog.Builder(OrderDetailActivity2.this).setCancelable(false).setTitle("提示").setMessage("由于您在15分钟内未操作该订单，您无法支付该订单")
        ...
        cancel_rl.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (countView.getRemainTime() < 60000) {
                    new AlertDialog.Builder(OrderDetailActivity2.this).setCancelable(false).setTitle("提示").setMessage("由于您在15分钟内未操作该订单，该订单将在1分钟内自动取消")
                            .setPositiveButton("知道了", new DialogInterface.OnClickListener() {
    ...
    private void initViews() {
        ...
        gson = new Gson();
        pDialog = new SweetAlertDialog(OrderDetailActivity2.this, SweetAlertDialog.PROGRESS_TYPE).setTitleText("正在加载中");
        pDialog.setCancelable(false);
        pDialog.getProgressHelper().setBarColor(ContextCompat.getColor(OrderDetailActivity2.this, R.color.blue_btn_bg_color));
        ...
        countView.setOnCountdownEndListener(new CountdownView.OnCountdownEndListener() {
            ...
            public void onEnd(CountdownView cv) {
                //计时结束处理
                EventBus.getDefault().post(new FirstEvent(MyConstant.EVENTBUS_ORDER_ONE));
                new AlertDialog.Builder(OrderDetailActivity2.this).setCancelable(false).setTitle("提示").setMessage("该订单将自动取消，请退出重新下单")
                        .setPositiveButton("知道了", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
    ...
    private void initStatus() {
        ...
        if (orderinfo.getOlstatus().equals("1")) {
        ...
        } else if (orderinfo.getOlstatus().equals("3")) {
            cancel_rl.setVisibility(View.GONE);
            ...
            bottom_tv.setVisibility(View.VISIBLE);
        } else if (orderinfo.getOlstatus().equals("2")) {
            if (orderinfo.getPaystatus().equals(MyConstant.PAY_SUCCESS)) {// 已付款，未接单
                status_card.setText("已付款");
                bottom_tv.setText("等待接单");
                cancel_rl.setVisibility(View.GONE);
            } else if (orderinfo.getPaystatus().equals(MyConstant.PAY_NO)) {//未付款，未接单
            ...
            bottom_tv.setVisibility(View.VISIBLE);
        } else if (orderinfo.getOlstatus().equals("4")) {
            cancel_rl.setVisibility(View.GONE);
            ...
            bottom_tv.setEnabled(false);
            bottom_tv.setVisibility(View.VISIBLE);
        } else if (orderinfo.getOlstatus().equals("5")) {
            cancel_rl.setVisibility(View.GONE);
            if (orderinfo.getPaystatus().equals(MyConstant.REFUND_APPLY)) {
                status_card.setText("退款中");
            } else if (orderinfo.getPaystatus().equals(MyConstant.REFUND_SUCCESS)) {
        ...
        number_tv.setText(orderinfo.getEatennum() + "");
        ...
        // setDateView(start_date2,MainTools.dayForWeek(orderinfo.getStartdate()));
        // setDateView(end_date2,MainTools.dayForWeek(orderinfo.getEnddate()));
    }
    ...
    private void showPayDialog() {
        setTheme(R.style.ActionSheetStyleIOS7);
        ActionSheet.createBuilder(OrderDetailActivity2.this, getSupportFragmentManager()).setCancelButtonTitle("取消")
            ...
            public void onOtherButtonClick(ActionSheet actionSheet, int index) {
                switch (index) {
                    case 0:
                        Dh_Alipay mypay = new Dh_Alipay(OrderDetailActivity2.this, mHandler);
                        ...
                        break;
                    case 1:
                        Dh_WechatPay wepay = new Dh_WechatPay(OrderDetailActivity2.this);
    ...
    private void postStatus(String olids, final String status, OrderInfo orderinfo) {
    ...
    public void onOtherButtonClick(ActionSheet actionSheet, int index) {
        switch (index) {
            case 0:
                Platform plat = ShareSDK.getPlatform(OrderDetailActivity2.this, Wechat.NAME);
                ...
                break;
            case 1:
                Platform plat2 = ShareSDK.getPlatform(OrderDetailActivity2.this, WechatMoments.NAME);
