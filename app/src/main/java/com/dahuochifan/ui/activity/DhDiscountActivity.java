...
import com.dahuochifan.ui.adapter.DiscountAdapter;
...
public class DhDiscountActivity extends BaseActivity implements PullToRefreshBase.OnRefreshListener2<ListView> {
    ...
    private void getMainData(final boolean isRefresh) {
        ...
        client.post(MyConstant.GET_DISCOUNT_ALL_LIST, params, new TextHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                MainTools.ShowToast(DhDiscountActivity.this, R.string.interneterror);
            }
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                ...
                if (data.dealData(responseString, DhDiscountActivity.this, gson) == 1) {
                ...
                } else if (data.dealData(responseString, DhDiscountActivity.this, gson) == -1) {
                    discountAll = data.getDiscountAll();
                    if (discountAll != null) {
                        String tag = discountAll.getTag();
                        int resultcode = discountAll.getResultcode();
                        if (!TextUtils.isEmpty(tag)) {
                            showTipDialog(DhDiscountActivity.this, tag, resultcode);
                        } else {
                            showTipDialog(DhDiscountActivity.this, "重新登录", resultcode);
                        }
                    }
                } else {
                    discountAll = data.getDiscountAll();
                    if (discountAll != null) {
                        String tag = discountAll.getTag();
                        if (!TextUtils.isEmpty(tag)) {
                            MainTools.ShowToast(DhDiscountActivity.this, tag);
                        }
                    }
                }
            }
