...
public class DhCircleImageView extends ImageView {
	...
	public DhCircleImageView(Context context) {
		super(context);

		init();
	}

	public DhCircleImageView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	private int paddingTop, paddingLeft, paddingRight, paddingBottom;

	public DhCircleImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawCircle(paddingLeft + (getWidth() - paddingRight - paddingLeft) / 2, paddingTop + (getHeight() - paddingTop - paddingBottom) / 2,
	...
	private void setup() {
		...
		mDrawableRect.set(mBorderWidth + paddingLeft, mBorderWidth + paddingTop, getWidth() - paddingRight - mBorderWidth, getHeight() - paddingBottom
				- mBorderWidth);
