...
public class SuccessTickViewWhite extends View {
    ...
    public SuccessTickViewWhite(Context context) {
        super(context);
        init(context);
    }

    public SuccessTickViewWhite(Context context, AttributeSet attrs){
        super(context,attrs);
        init(context);
    }
