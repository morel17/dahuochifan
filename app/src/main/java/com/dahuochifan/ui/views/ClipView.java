...
public class ClipView extends View {
	...
	public ClipView(Context context) {
		super(context);
		clipWidth=context.getResources().getDimensionPixelSize(R.dimen.width_35_80);
		clipHeight=context.getResources().getDimensionPixelSize(R.dimen.width_35_80);
	}
