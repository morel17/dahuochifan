...
import com.dahuochifan.crop.ImageLoader.Type;
...
public class IViewHolder
{
	 ...
	 * @return
	 */
	public static IViewHolder get(Context context, View convertView,
			ViewGroup parent, int layoutId, int position)
	{
		IViewHolder holder = null;
		if (convertView == null)
		{
			holder = new IViewHolder(context, parent, layoutId, position);
		} else
		{
	 ...
	 * @return
	 */
	public IViewHolder setText(int viewId, String text)
	{
	 ...
	 * @return
	 */
	public IViewHolder setImageResource(int viewId, int drawableId)
	{
